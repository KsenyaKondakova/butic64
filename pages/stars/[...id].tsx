...
const Stars = () => {
  ...
  return (
    <Layout
      title="Бутик 64 ЗВЕЗДЫ"
      description="Погрузитесь в мир звезд с нашей страницей 'Звезды' от Бутик 64! Здесь вы найдете уникальные портреты и интервью с интересными личностями, которые разместились на нашем сайте. От известных актеров и музыкантов до успешных предпринимателей и общественных деятелей - каждая звезда имеет свою историю. Посетите наш сайт и познакомьтесь с увлекательными историями жизни замечательных людей!"
      keywords="звезды, интервью, портреты, известные личности, знаменитости, актеры, музыканты, предприниматели, общественные деятели, знаменитости города"
    >
      <News
        news={mergeNews}
