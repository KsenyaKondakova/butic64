...
export default function Home() {
  ...
  return (
    <Layout
      title="Бутик 64 : светский портал"
      description="Бутик 64 - ваш источник новостей города, интересные мероприятий и красочных фотографий различных мест. Посетите наш сайт, чтобы быть в курсе всех событий и открытий в городе Саратов!"
      keywords="бутик64, Бутик 64, бутик 64 рф, бутик светский портал"
    >
      <News
        news={mergeNews}
