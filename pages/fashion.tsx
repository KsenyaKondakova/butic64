...
function Lifestyle() {
  ...
  return (
    <Layout
      title="Бутик 64 FASHION"
      description="Окунитесь в мир моды и красоты на странице 'Fashion' от Бутик 64! Здесь вы найдете вдохновляющие заведения, такие как ювелирные мастерские, модельные агентства и многое другое. Разнообразие представленных возможностей позволит вам найти идеальное место для украшения своего стиля и выражения себя через моду и красоту. Погрузитесь в мир великолепия и создайте свой неповторимый образ с помощью 'Fashion' от Бутик 64!"
      keywords="Бутик 64, FASHION, фэшн,  мода, красота, ювелирная студия, модели, агенство, светский портал, современная мода"
    >
      <News
        news={mergeNews}
